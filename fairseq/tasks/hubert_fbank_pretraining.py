...
from fairseq.data import Dictionary, HubertfbankDataset  #change
...
@register_task("hubert_fbank_pretraining", dataclass=HubertPretrainingConfig)   #change
class HubertfbankPretrainingTask(FairseqTask):   #change
    ...
    def __init__(
        ...
        logger.info(f"HubertfbankPretrainingTask Config {cfg}")
    ...
    ) -> "HubertfbankPretrainingTask":    #change
        return cls(cfg)
    ...
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        self.datasets[split] = HubertfbankDataset(   # #change
            manifest,
